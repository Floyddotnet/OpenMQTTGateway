...
bool updateWorB(JsonObject &BTdata, bool isWhite)
{
  ...
  for (int i = 0; i < size; i++)
  {
    ...
    creadeOrUpdateDevice(mac, NULL /*isDisc*/, isWhite /*isWhite*/);
  }
  
  return true;
}

void creadeOrUpdateDevice(const char *mac, bool isDisc, bool isWhite)
{
...
#define MiFloraparametersCount 4
  ...
  creadeOrUpdateDevice(mac, true /*isDisc*/, NULL /*isWhite*/);
}
